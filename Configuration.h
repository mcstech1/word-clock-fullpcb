...
// Configuration.h
//
// This file stems from the QlockWork firmware (https://github.com/ch570512/Qlockwork)
// and is licensed under the GNU GPL v3 — the same licence as QlockWork. It is the working configuration for
// this board (114× SK6812, LED data on GPIO15/D8, LDR on A0, vertical layout).
// See the project README "Firmware & pinout" section for details.
//
